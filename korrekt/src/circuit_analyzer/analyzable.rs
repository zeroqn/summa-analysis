...
impl<F: AnalyzableField> Assignment<F> for Analyzable<F> {
    #[cfg(any(feature = "use_pse_halo2_proofs", feature = "use_axiom_halo2_proofs",feature = "use_scroll_halo2_proofs", feature = "use_pse_v1_halo2_proofs", feature = "use_summa_halo2_proofs"))]
        ...
        N: FnOnce() -> NR,
    {
        ...
        self.current_region = Some(Region {
            ...
            rows: None,
            #[cfg(any(feature = "use_zcash_halo2_proofs", feature = "use_axiom_halo2_proofs",feature = "use_pse_halo2_proofs",feature = "use_scroll_halo2_proofs", feature = "use_summa_halo2_proofs"))]
    ...
    #[cfg(any(feature = "use_zcash_halo2_proofs", feature = "use_pse_halo2_proofs",feature = "use_scroll_halo2_proofs", feature = "use_pse_v1_halo2_proofs", feature = "use_summa_halo2_proofs"))]
        ...
        AR: Into<String>,
    {
        ...
        if let Some(region) = self.current_region.as_mut() {
            ...
            #[cfg(any(feature = "use_pse_halo2_proofs",feature = "use_pse_v1_halo2_proofs",feature = "use_scroll_halo2_proofs", feature = "use_summa_halo2_proofs"))]
            region
                .cells
        ...
        AR: Into<String>,
    {
        ...
        if let Some(region) = self.current_region.as_mut() {
            region.update_extent(column.into(), row);
            #[cfg(any(feature = "use_pse_halo2_proofs",feature = "use_pse_v1_halo2_proofs", feature = "use_summa_halo2_proofs"))]
            region
                .cells
                .entry((column.into(), row))
                .and_modify(|count| *count += 1)
